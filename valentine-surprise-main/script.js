        ...
        content.innerHTML = `
            <div class="envelope-wrapper">
                <div id="envelope" class="close">
                    ...
                    <div class="letter">
                        <p class="words line1">Happy Valentine's day Bby <3</p>
                        <p class="words line2">Always remember that u desserve all </p>
                        <p class="words line3">the love and happiness this world</p>
                        <p class="words line4">Could give :)) </p>
						<p class="words line4"></p>
						<p class="words line4">-Dianagustine</p>
                    </div>
                    </div>
                </div>
            </div>
            ...
            document.getElementById("yesBtn").addEventListener("click", function () {
                content.innerHTML = `
					<div style="text-align: center;">
						...
						<p style="font-size: 24px;">Yaaaaaay!</p>
					</div>
                ...
                document.getElementById("surpriseBtn").addEventListener("click", function () {
                    content.innerHTML = `
						<div style="text-align: center; margin-top: 20px;">
							<img src="pictures/firstlove.jpg" alt=" Image" style="width: 70%; max-width: 500px; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2); margin-bottom: 20px;">
							<br>
							<a id="downloadBtn" href="pictures/firstlove.jpg" download style="display: inline-block; padding: 12px 25px; background: #FF6863; color: white; border-radius: 5px; text-decoration: none; font-size: 18px; font-weight: bold; transition: 0.3s;">Download Image</a>
						</div>
					`;
                });
            });
